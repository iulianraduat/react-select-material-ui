...
export const WithAndWithoutFullWidthSet: ComponentStory<
...
export const notAllowingCreatingNewOptions: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const allowingCreatingNewOptions: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const WithOptionsHavingLabelAndValueEqual: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const WithOptionsHavingLabelAndValueDifferent: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const WithAnEmptyStringAsInitialValue: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const WithAndWithoutHelperText: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const WithCustomizedMessages: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const ClearValuesButton: ComponentStory<typeof ReactSelectMaterialUi> =
  () => <ClearValues disabled={false} />;

export const NoClearValuesButtonWhenComponentIsDisabled: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => <ClearValues disabled={true} />;

export const AddingOptionsInAMultipleSelect: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const ChangingANewlyAddedOption: ComponentStory<
  typeof ReactSelectMaterialUi
> = () => (
  <div>
    <ReactSelectMaterialUi
...
export const Disabled: ComponentStory<typeof ReactSelectMaterialUi> = () => (
  <div>
    <ReactSelectMaterialUi
      label="Single select"
      options={simpleOptions}
...
export const Styled: ComponentStory<typeof ReactSelectMaterialUi> = () => (
...
export const DarkTheme: ComponentStory<typeof ReactSelectMaterialUi> = () => (
